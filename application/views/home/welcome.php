			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="widget widget-stats bg-success">
						...
						<div class="stats-info">
							<h4>Begining Cash Onhand</h4>
							<p><?php print_r(number_format($service[0],0));?></p>	
						</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="widget widget-stats bg-info">
						...
						<div class="stats-info">
							<h4>Cash Going In</h4>
							<p><?php print_r(number_format($service[1],0));?></p>	
						</div>
						<div class="stats-link">
				...
				<div class="col-lg-8">
					...
					<div class="panel panel-success" data-sortable-id="index-1">
						<div class="panel-heading">
							...
							<h4 class="panel-title" id="titleChart">Estate production</h4>
						</div>
						...
						<div class="panel-body p-t-0">
							<div class="table-responsive">
								<table class="table table-valign-middle">
									...
									<tbody>
										<tr>
											<td><label class="label label-success">Estate Production</label></td>
											<td><?php print_r(number_format($service[0],0));?><span class="text-success"><i class="fa fa-arrow-up"></i></span></td>
											<td><div id="sparkline-unique-visitor"></div></td>
										</tr>
										<tr>
											<td><label class="label label-info">Mill Production</label></td>
											<td><?php print_r(number_format($service[1],0));?></td>
											<td><div id="sparkline-bounce-rate"></div></td>
										</tr>
										<tr>
											<td><label class="label label-success">BJR</label></td>
											<td><?php print_r(number_format($service[2],2));?></td>
											<td><div id="sparkline-total-page-views"></div></td>
										</tr>
										<tr>
											<td><label class="label label-primary">Sales</label></td>
											<td>0</td>
											<td><div id="sparkline-avg-time-on-site"></div></td>
										</tr>
										<tr>
											<td><label class="label label-default">Rainfall</label></td>
											<td></td>
											<td><div id="sparkline-new-visits"></div></td>
										</tr>
										<tr>
											<td><label class="label label-inverse">Employee</label></td>
											<td></td>
