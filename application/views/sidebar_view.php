	...
	<ul class="nav">
		<li class="nav-profile">
			<a href="javascript:;" data-toggle="nav-profile">
				...
				<div class="info">
					<b class="caret pull-right"></b><?php echo $this->session->userdata('username'); ?><small>admin@kpn-corp.com</small>
				</div>
			</a>
		</li>
		<li>
	...
	<ul class="nav">
		...
		<!-- <li class="has-sub">
			...
			<ul class="sub-menu">
				...
				<li><a href="<?php echo site_url() ?>/AttendanceSubmission">Cash Out Authorization</a></li>
			</ul>
		</li> -->
		<li class="has-sub">
			<a href="javascript:;">
			...
			<ul class="sub-menu">
				<li class="has-sub">
					<a href="<?php echo site_url() ?>/MasterBank"> Master User </a>
				</li>
				<li class="has-sub">
					<a href="<?php echo site_url() ?>/MasterBank"> Master Role </a>
				</li>
			</ul>
		</li>
		<!-- <li class="has-sub">
